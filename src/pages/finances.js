...
const parseOverview = (sourceRoot) => {
...
export function initFinancesPage(main) {
    const sourceRoot = document.querySelector('.main_center');
    if (!main || !sourceRoot) return;
    if (!sourceRoot.querySelector('.column1 .content_menu, .column2_a #finances, .column2_a #finances_year')) return;
