...
const GLOBALS = {
    ...
    TmSync:            'lib/tm-dbsync.js',
    // shared components
    TmUI:              'components/shared/tm-ui.js',
    TmCanvasUtils:     'components/shared/tm-canvas-utils.js',
    // dbinspect / dbrepair
    TmDbInspectStyles: 'components/dbinspect/tm-dbinspect-styles.js',
    TmDbRepairStyles:  'components/dbrepair/tm-dbrepair-styles.js',
    // import
    TmImportStyles:    'components/import/tm-import-styles.js',
    TmImportSync:      'components/import/tm-import-sync.js',
    // history
    ...
    // player
    TmPlayerStyles:    'components/player/tm-player-styles.js',
    TmPlayerCard:      'components/player/tm-player-card.js',
    TmPlayerTooltip:   'components/player/tm-player-tooltip.js',
    TmPlayerSidebar:   'components/player/tm-player-sidebar.js',
    TmSidebarNav:      'components/player/tm-sidebar-nav.js',
    TmSkillsGrid:      'components/player/tm-skills-grid.js',
    TmHistoryMod:      'components/player/tm-history-mod.js',
    TmScoutMod:        'components/player/tm-scout-mod.js',
    TmTrainingMod:     'components/player/tm-training-mod.js',
    TmGraphsMod:       'components/player/tm-graphs-mod.js',
    TmTabsMod:         'components/player/tm-tabs-mod.js',
    TmAsiCalculator:   'components/player/tm-asi-calculator.js',
    TmBestEstimate:    'components/player/tm-best-estimate.js',
    // shortlist
