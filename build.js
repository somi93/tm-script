...
function generateMainStub(bundleHash) {
    ...
    if (isLocal) {
        ...
        lines.push('// @require      ' + BASE + '/dist/tm-bundle.js');
    } else {
        const HUB = 'https://raw.githubusercontent.com/somi93/tm-script/main';
        lines.push('// @updateURL    ' + HUB + '/tm.user.js');
        lines.push('// @downloadURL  ' + HUB + '/tm.user.js');
        lines.push('// @require      ' + BASE + '/dist/tm-bundle.js?v=' + bundleHash);
    }
    ...
    if (isLocal) {
        ...
        const HUB = 'https://raw.githubusercontent.com/somi93/tm-script/main';
        lines.push('// NOTE: Production build using @require. Sync with GitHub/GreasyFork via ' + HUB + '/tm.user.js');
    }
